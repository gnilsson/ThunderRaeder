...
namespace ThunderRaeder.Identity.API.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSettings,
            TokenValidationParameters tokenValidationParameters, ThunderRaederDbContext dbContext,
        ...
        // TODO: Refactor to not show explicit messages
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult { Errors = new[] { "This refresh token is invalidated" } };
            }
